...
class EditNotification extends StatefulWidget {
  final NotificationDetum notification;
              ...
              children: [
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                      title: Text("${outputDateFormat.format(widget.notification!.date!)}",
                        style: TextStyle(
                          fontSize: 17,
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                      title: Text("${widget.notification!.time}",
                        style: TextStyle(
                          fontSize: 17,
                          fontWeight: FontWeight.w500,
                        ),
                ...
                _image != null ? Column(
                  children: [
                    ...
                    ? Image.network("https://st4.depositphotos.com/16712942/23940/i/450/depositphotos_239404444-stock-photo-gift-box-wrapped-brown-colored.jpg",
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                      ...
                      subtitle: _getUserToken.isNotEmpty ? Text(" Total selected Team: ${_getUserToken.length}") : Text(" Total have selected Team: ${widget.notification!.userList!.length}"),
